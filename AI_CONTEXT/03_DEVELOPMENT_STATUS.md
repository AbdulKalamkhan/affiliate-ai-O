...
- Tests: PASS — @ai-os/api jest: 9 suites / 86 tests (verified 2026-09-25: 72 + 14 revenue.service.spec; fake-db.ts stamps createdAt like Prisma and supports count/aggregate/_count/orderBy/take/include); database/web: no tests configured
