...
- Tests: PASS — @ai-os/api jest: 9 suites / 88 tests (verified 2026-09-25: 86 + dashboard conversions-semantics fix +2 revenue audit-trail tests; fake-db.ts stamps createdAt like Prisma and supports count/aggregate/_count/orderBy/take/include); database/web: no tests configured
