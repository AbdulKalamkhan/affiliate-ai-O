...
- Tests: PASS — @ai-os/api jest: 8 suites / 72 tests (verified 2026-09-25: 71 + rate-limit spoof-resistance 1; fake-db.ts stamps createdAt like Prisma and supports count/aggregate/_count/orderBy/take/include); database/web: no tests configured
